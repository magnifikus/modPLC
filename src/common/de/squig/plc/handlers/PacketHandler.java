...
import de.squig.plc.network.PLCPacket;
import de.squig.plc.network.PacketTypeHandler;
...
public class PacketHandler implements IPacketHandler {
    ...
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player) {
    	...
    	PLCPacket plcPacket = PacketTypeHandler.buildPacket(packet.data);
    	
    	// Execute the appropriate actions based on the PacketEE type
    	plcPacket.execute(manager, player);
    }
